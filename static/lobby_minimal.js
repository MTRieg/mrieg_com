...
function setStatus(newStatus) {
  ...
  if (_status.includes('p')) {
    ...
    ui.createBtn.textContent = 'Join with New Username';
 ...
 * @param {string} startDeadline - Game start deadline text
 */
export function updateGameInfo(gameId, inviteUrl, startDeadline) {
  ...
  ui.startInfo.textContent = `Game starts at: ${startDeadline || 'soon'}`;
}
